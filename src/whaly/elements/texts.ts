...
export const unexpectedDisconnectReason =
  "Whaly has been disconnected for unexpected reason"
export const forcedDisconnectReason =
  "Someone disconnected Whaly from the channel :/"

export const notInVoiceChannelError = `You must be in a voice channel to use this command!`
export const differentChannelError =
...
export const skipPlayingTrackHint =
  "Sounds like there is a track playing. To clear try **/skip**"
export const nothingToBeCleared = "Phew ~ There is nothing to be cleared."
export const clearedNItems = (count: number) =>
